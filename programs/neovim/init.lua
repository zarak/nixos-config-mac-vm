...
require 'lspconfig'.emmet_ls.setup { on_attach = on_attach, filetypes = { 'html', 'css', 'php' } }
...
-- vim-mundo config
vim.keymap.set('n', '<leader>m', ':MundoToggle<CR>', { desc = '[m] Mundo (undo tree)' })

-- Insert time
vim.keymap.set('n', '<leader>t', ':pu=strftime(\'%c\')<CR>', { desc = '[t] Insert current date and time' })

-- Bindings for plugin development
vim.keymap.set('n', '<leader>px', ':source %<CR>',
  { desc = 'E[x]ecute the currently open development [p]lugin source file' })
...
require("luasnip").config.set_config({ -- Setting LuaSnip config
  ...
  -- Get rid of unconsumed jump points in snippets
