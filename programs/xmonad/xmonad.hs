...
mkRofiCommand folder =
  "rofi -dpi 224 -modi filebrowser -show filebrowser -file-browser-dir '~/" <> show folder <> "' -file-browser-depth 3"
...
myAdditionalKeys =
  ...
  [ ("M-S-<Return>", spawn myTerminal),
    ...
    ("M-p", spawn "rofi -no-lazy-grab -show drun -modi drun -dpi 224"),
